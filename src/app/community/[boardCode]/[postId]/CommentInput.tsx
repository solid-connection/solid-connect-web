...
const CommentInput = ({ postId, curSelectedComment, setCurSelectedComment, refresh }: CommentInputProps) => {
  ...
  return (
    <div className="min-w-app max-w-app fixed bottom-14 flex w-full items-center gap-3 border-t border-bg-400 bg-k-0 p-2">
      <div className="w-full">
        {curSelectedComment && (
          <div className="flex h-10 w-full items-center justify-between rounded-t-lg bg-bg-500 px-2.5 pb-2.5 pt-3">
            <span className="typo-regular-4 text-gray-150">답글을 입력중입니다..</span>
            <button
        ...
        <input
          className="h-10 w-full overflow-hidden text-ellipsis rounded-lg border-none bg-bg-400 p-2.5 typo-regular-2 outline-none placeholder:text-gray-150"
          value={content}
