    ...
    <div className="px-5">
      <FormProvider {...method}>
        <form onSubmit={handleSubmit(onSubmit)}>
          {/* Profile Header */}
          <div className="gap-4">
            <h1 className="typo-sb-5 text-gray-900">나의 멘토</h1>
            <div className="flex gap-4">
              ...
              <div className="flex flex-col gap-[8px]">
                <div className="typo-regular-2 text-gray-500">{country}</div>
                <div className="typo-sb-5 text-gray-900">{nickname}</div>
                <div className="typo-regular-2 text-gray-500">{universityName}</div>
                <StudyDate term={term} />
              </div>
            </div>
          </div>
          <div className="mt-10">
            <h2 className="mb-2.5 typo-sb-5 text-primary-1">내 채널 관리</h2>
            <ChannelBox channels={channels} />
            {/* 4개의 고정된 채널 입력 필드 */}
            <h2 className="mt-10 typo-sb-5 text-primary-1">멘토 한마디</h2>
            <textarea
              {...register("introduction")}
              className="mt-2.5 h-30 w-full rounded-lg bg-k-50 p-5 typo-regular-2 text-k-300"
              placeholder="최대 200자 이내"
            />
            {errors.introduction && (
              <p className="mt-1 typo-regular-2 text-red-500">
                {typeof errors.introduction === "object" && errors.introduction.message
                  ? errors.introduction.message
                  : "멘토 한마디를 입력해주세요"}
              </p>
            )}
            <h2 className="mt-10 typo-sb-5 text-primary-1">합격 레시피</h2>
            <textarea
              {...register("passTip")}
              className="mt-2.5 h-30 w-full rounded-lg bg-k-50 p-5 typo-regular-2 text-k-300"
              placeholder="최대 200자 이내"
            ...
            <h2 className="mt-10 typo-sb-5 text-primary-1">멘토 아티클</h2>
