    ...
    <form className={styles.form}>
      <div className={styles.rating}>
        {[...Array(totalStars)].map((_, index) => {
          let filled = ["#6F90D1", "#6F90D1", "1", "1"];
          if (rating > index + 0.5) {
            filled = ["#6F90D1", "#6F90D1", "1", "1"];
          } else if (rating > index) {
            filled = ["#6F90D1", "#000000", "1", "0.54"];
          } else {
            filled = ["#000000", "#000000", "0.54", "0.54"];
          }
          return (
            <StarFilledIcon
      ...
      <textarea className={styles.content} placeholder="학교에 대한 생생한 후기를 들려주세요." />
