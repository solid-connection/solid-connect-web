export default function StarFilledIcon({ size = "20", leftColor = "#000000", rightColor = "#000000", leftOpacity = "1", rightOpacity = "1", onClick: any, style = {} }) {
  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 20 20" fill="none" onClick={onClick} style={style}>
      ...
      <path d="M10.0003 14.8085L15.1503 17.9168L13.7837 12.0585L18.3337 8.11683L12.342 7.6085L10.0003 2.0835L7.65866 7.6085L1.66699 8.11683L6.21699 12.0585L4.85033 17.9168L10.0003 14.8085Z" fill={`url(#${gradientId})`} />
    </svg>
  );
}
