...
export const universitiesApi = {
  getRecommendedUniversities: async (params: { params?: Record<string, unknown> }): Promise<RecommendedUniversitiesResponse> => {
  ...
  getIsWish: async (params: { univApplyInfoId: string | number, params?: Record<string, unknown> }): Promise<IsWishResponse> => {
  ...
  getUniversityDetail: async (params: { univApplyInfoId: string | number, params?: Record<string, unknown> }): Promise<UniversityDetailResponse> => {
  ...
  getSearchText: async (params: { params?: Record<string, unknown> }): Promise<SearchTextResponse> => {
