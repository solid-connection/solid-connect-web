...
export type 멘토 승격 요청Response = void;

export type 멘토 승격 요청Request = Record<string, never>;
...
export const mentorApi = {
  ...
  post멘토 승격 요청: async (params: { data?: 멘토 승격 요청Request }): Promise<멘토 승격 요청Response> => {
    const res = await axiosInstance.post<멘토 승격 요청Response>(
