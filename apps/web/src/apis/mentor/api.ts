...
export const mentorApi = {
  getMatchedMentors: async (params: { defaultSize: string | number, defaultPage: string | number, params?: Record<string, unknown> }): Promise<MatchedMentorsResponse> => {
  ...
  getAppliedMentorings: async (params: { verifyStatus: string | number, defaultSize: string | number, defaultPage: string | number, params?: Record<string, unknown> }): Promise<AppliedMentoringsResponse> => {
  ...
  getMentorList: async (params: { defaultSize: string | number, defaultPage: string | number, params?: Record<string, unknown> }): Promise<MentorListResponse> => {
  ...
  getMentorDetail: async (params: { mentorId: string | number, params?: Record<string, unknown> }): Promise<MentorDetailResponse> => {
  ...
  getMyMentorPage: async (params: { params?: Record<string, unknown> }): Promise<MyMentorPageResponse> => {
  ...
  getReceivedMentorings: async (params: { params?: Record<string, unknown> }): Promise<ReceivedMentoringsResponse> => {
  ...
  getUnconfirmedMentoringCount: async (params: { params?: Record<string, unknown> }): Promise<UnconfirmedMentoringCountResponse> => {
