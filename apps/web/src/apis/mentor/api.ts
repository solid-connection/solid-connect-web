...
export type ApplyMentorApplicationResponse = void;

export type ApplyMentorApplicationRequest = Record<string, never>;
...
export type CreateMentorMyPageResponse = void;

export type CreateMentorMyPageRequest = Record<string, never>;
...
export const mentorApi = {
  ...
  postApplyMentorApplication: async (params: { data?: ApplyMentorApplicationRequest }): Promise<ApplyMentorApplicationResponse> => {
    const res = await axiosInstance.post<ApplyMentorApplicationResponse>(
  ...
  postCreateMentorMyPage: async (params: { data?: CreateMentorMyPageRequest }): Promise<CreateMentorMyPageResponse> => {
    const res = await axiosInstance.post<CreateMentorMyPageResponse>(
      `/mentor/my`, params?.data
    );
    return res.data;
  },
