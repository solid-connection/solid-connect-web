...
const SignupPolicyScreenBase = ({ toNextStage, isDesktop }: SignupPolicyScreenProps & { isDesktop: boolean }) => {
  ...
  return (
    <div className={isDesktop ? "" : "mt-[-56px]"}>
      ...
      <div
        className={isDesktop ? "mt-5 flex flex-col rounded-lg border border-k-100 p-4" : "flex flex-col py-5 pl-4 pr-5"}
      >
      ...
      <div className={isDesktop ? "mt-8" : "mt-10 px-5 pb-7"}>
        <BlockBtn className={isChecked ? "bg-primary" : "bg-bg-800"} disabled={!isChecked} onClick={toNextStage}>
          다음
        </BlockBtn>
      </div>
    </div>
