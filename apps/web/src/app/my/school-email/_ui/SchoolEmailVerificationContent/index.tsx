...
const DesktopSchoolEmailDoneView = ({ onHomeClick }: SchoolEmailDoneViewProps) => (
  <div className="min-h-screen bg-k-50 px-8 py-8 lg:px-10">
    ...
    <section className="flex min-h-[520px] flex-col items-center justify-center rounded-lg border border-k-100 bg-white p-8 text-center">
      ...
      <div className="mt-10 w-full max-w-sm">
        <BlockBtn onClick={onHomeClick}>홈으로</BlockBtn>
      </div>
    </section>
  </div>
);

const MobileSchoolEmailDoneView = ({ onHomeClick }: SchoolEmailDoneViewProps) => (
