      ...
      return (
        <div className="min-h-screen bg-k-50 px-8 py-8 lg:px-10">
          ...
          <section className="flex min-h-[520px] flex-col items-center justify-center rounded-lg border border-k-100 bg-white p-8 text-center">
            ...
            <p className="mt-3 text-k-500 typo-medium-2">
              인증된 학교 정보를 기반으로 솔리드 커넥션을 이용할 수 있어요.
            </p>
      ...
      <div className="min-h-screen bg-k-50 px-8 py-8 lg:px-10">
        ...
        <div className="grid items-start gap-8 xl:grid-cols-[minmax(420px,640px)_minmax(280px,360px)]">
          <section className="rounded-lg border border-k-100 bg-white p-6">
            <Progress value={progressValue} showPercentage={false} />
            ...
            <div className="mt-8 flex flex-col gap-5">
              <div>
                <Label htmlFor="desktopSchoolEmail" className="text-k-900">
                  학교 이메일
                </Label>
                <Input
                  id="desktopSchoolEmail"
                  variant="gray"
              ...
              {step === "code" && (
                <div>
                  <Label htmlFor="desktopVerificationCode" className="text-k-900">
                    인증번호
                  </Label>
                  <div className="relative">
                    <Input
                      id="desktopVerificationCode"
                      variant="gray"
