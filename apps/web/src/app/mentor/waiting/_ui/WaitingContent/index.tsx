...
const WaitingContent = () => {
  ...
  return isDesktop ? <DesktopWaitingView {...viewProps} /> : <MobileWaitingView {...viewProps} />;
};

type WaitingViewProps = {
  approveList: NonNullable<ReturnType<typeof useGetApplyMentoringList>["data"]>;
  pendingList: NonNullable<ReturnType<typeof useGetApplyMentoringList>["data"]>;
  totalLength: number;
};

const DesktopWaitingView = ({ approveList, pendingList }: WaitingViewProps) => (
...
const MobileWaitingView = ({ approveList, pendingList, totalLength }: WaitingViewProps) => (
