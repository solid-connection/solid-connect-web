...
const PostWriteButton = ({ onClick }: PostWriteButtonProps) => {
  ...
  return (
    <div
      className={`fixed bottom-16 flex w-full max-w-app flex-col items-center transition-transform duration-300 ease-in-out md:bottom-6 md:left-0 md:w-full md:max-w-none ${isVisible ? "translate-y-0" : "translate-y-[calc(100%+66px)]"} `}
    >
      <button
