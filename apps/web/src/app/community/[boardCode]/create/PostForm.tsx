...
type PostFormViewProps = PostEditorProps & {
  submitPost: () => void;
};
...
const PostForm = ({ boardCode }: PostFormProps) => {
  ...
  if (isDesktop) {
    return <DesktopPostFormView {...editorProps} submitPost={submitPost} />;
  }

  return <MobilePostFormView {...editorProps} submitPost={submitPost} />;
};

type PostEditorBaseProps = PostEditorProps & {
  isDesktop: boolean;
};

const PostEditorBase = ({
  titleRef,
  textareaRef,
  content,
  setContent,
...
const DesktopPostEditor = (props: PostEditorProps) => <PostEditorBase {...props} isDesktop />;

const MobilePostEditor = (props: PostEditorProps) => <PostEditorBase {...props} isDesktop={false} />;

const DesktopPostFormView = (props: PostFormViewProps) => {
  const { submitPost, selectedImages, maxImages } = props;
...
const MobilePostFormView = ({ submitPost, ...editorProps }: PostFormViewProps) => (
  <>
    <TopDetailNavigation
      title="글쓰기"
      icon={
