...
import { o as getNormalizedURL, p as getOrigin, q as createSerializationAdapter, u as attachRouterServerSsrUtils, v as createRawStreamRPCPlugin, i as isNotFound, b as isRedirect, w as isResolvedRedirect, x as mergeHeaders, y as executeRewriteInput, z as defaultSerovalPlugins, A as makeSerovalPlugin, a as rootRouteId, C as defineHandlerCallback } from "../_chunks/_libs/@tanstack/router-core.mjs";
import { AsyncLocalStorage } from "node:async_hooks";
import { e as H3Event, f as toResponse } from "../_libs/h3.mjs";
...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-Cijt78HO.mjs");
...
async function loadEntries() {
  const routerEntry = await import("./router-D5H6tH2r.mjs").then((n) => n.d);
